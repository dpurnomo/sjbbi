...
<div class="card">
  <div class="card-body">
	<h3 class="card-title"><i class="far fa-calendar-alt"></i> SEJAK 1 BULAN LALU <a href="meeting_tugas-all.php" class="btn btn-primary">RIWAYAT</a></h3>
		<?php include_once('includes/dbconfig.php');
		$sql = "SELECT * FROM Meetings WHERE date >= DATE_SUB(NOW(), INTERVAL 1 MONTH) && type='Tengah Pekan' ORDER BY date";
